                ...
                <Tabs defaultValue="params">
                  ...
                  >
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="mt-2 font-outfit text-white hover:text-black"
                    >
                      <Plus className="mr-2 h-3 w-3 font-outfit text-white hover:text-black" />
                      Add Header
                    </Button>
                  ...
                  >
                    <Select defaultValue="json">
                      ...
                      <SelectContent>
                        <SelectItem className="font-outfit" value="json">
                          application/json
                        </SelectItem>
                        <SelectItem className="font-outfit" value="form">
                          multipart/form-data
                        </SelectItem>
                        <SelectItem className="font-outfit" value="text">
                          text/plain
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  >
                    <Select defaultValue="bearer">
                      ...
                      <SelectContent>
                        <SelectItem className="font-outfit" value="none">
                          No Auth
                        </SelectItem>
                        <SelectItem className="font-outfit" value="basic">
                          Basic Auth
                        </SelectItem>
                        <SelectItem className="font-outfit" value="bearer">
                          Bearer Token
                        </SelectItem>
                        <SelectItem className="font-outfit" value="oauth2">
                          OAuth 2.0
                        </SelectItem>
                      </SelectContent>
                    </Select>
        ...
        <div className="mb-6">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                <CardTitle className="font-outfit bg-gradient-to-r from-red-500 via-orange-500 via-yellow-500 via-green-500 via-blue-500 via-indigo-500 to-purple-500 bg-clip-text text-transparent rainbow-animation">
                  Response
                </CardTitle>
                <CardDescription className="text-zinc-400 font-outfit">
            ...
            <CardContent>
              <div className="space-y-4">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="flex items-start space-x-4 border-b border-zinc-800 pb-4 last:border-0 font-outfit text-white"
                  >
                    <div
